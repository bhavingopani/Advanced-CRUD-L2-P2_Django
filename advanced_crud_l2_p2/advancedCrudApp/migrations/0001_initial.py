...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Hobby',
            fields=[
                ('hobby_id', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hobby_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='advancedCrudApp.hobby')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='advancedCrudApp.user')),
            ],
        ),
        migrations.AddField(
            model_name='user',
            name='user_address_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='advancedCrudApp.useraddress'),
        ),
    ]
